...
const tierIcons = [
  // Light (Basic)
  <svg className="switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36" key="light">
  ...
  // Dark (Standard)
  <svg className="switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36" key="dark">
  ...
  // Dim (Premium)
  <svg className="switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36" key="dim">
...
export const TierSwitcherGlass: React.FC<{
  ...
  return (
    <fieldset className={`switcher ${className}`} ref={fieldsetRef}>
